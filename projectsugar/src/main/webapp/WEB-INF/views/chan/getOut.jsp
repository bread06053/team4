...
<link rel="stylesheet" href="/css/getOut.css"/>
...
<div class="quitSite">
<div class="userprof">
   <img src="/profile/<sec:authentication property = "principal.user.profile"/>"><br>
 <sec:authentication property = "principal.user.nickname"></sec:authentication>의 페이지<br>
  <sec:authentication property = "principal.user.pr"></sec:authentication>
</div>
<div class="container2">
        <ul class="tabs">
            <li class="tab-link" data-tab="tab">회원 탈퇴</li>
        </ul>
        <input type="text" name="userid" id="userid"placeholder="아이디를 입력해주세요." class="in"><br>
        <input type="text" name="passwd" id ="passwd" placeholder="비밀번호를 입력해주세요." class="in">
        <br><input type="submit" id="btn" value="회원 탈퇴"><br>
        </div>
    </div>
